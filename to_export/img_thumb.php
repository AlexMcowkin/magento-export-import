...
$csv_file = '"entity_id";"thumb_image"'."\r\n";
...
ON mcpf1.entity_id=mcpve.entity_id WHERE mcpf1.price > 0 AND mcpve.attribute_id = 81 ORDER BY mcpf1.entity_id";
$query = $db->query($sql);

...
$csv_file = '"product_id";"full_descr"'."\r\n";
...
ON mcpf1.entity_id=mcpet.entity_id WHERE mcpf1.price > 0 AND mcpet.attribute_id = 67 ORDER BY mcpf1.entity_id";
$query = $db->query($sql);
